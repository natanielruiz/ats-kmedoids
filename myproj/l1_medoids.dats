...
// Implement the L1 version of k-medoids
extern
fun
KMedoidsTrainL1
...
implement main0() =
{
    ...
    val n_clusters = 2
    val (medoids, clusters, cost) = KMedoidsTrainL1(p, n_clusters)
